...
namespace Camunda.Api.Client.Filter
{
    public class FilterResource
    {
        ...
        /// <returns></returns>
        public Task<List<UserTaskInfo>> ExecuteList(int firstResult, int maxResults) => _api.ExecuteList(_filterId, firstResult, maxResults);

        /// <summary>
        /// Executes the saved query of the filter by id and returns the count.
        /// </summary>
        /// <returns></returns>
        public async Task<int> ExecuteCount() => (await _api.ExecuteCount(_filterId)).Count;
